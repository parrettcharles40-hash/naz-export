...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  // Herbal Infusions
  {
    ...
    unit: 'kg',
    shortDescription:
      'Sun-dried Mohammadi rosebuds cultivated in Kashan and Lalehzar mountain valleys, rich in gentle floral fragrance and antioxidants.',
    fullDescription:
      'Persian Damask rosebuds (Rosa damascena) are renowned worldwide for their intoxicating fragrance and natural essential oils. Harvested in early dawn during peak flowering, they are dried in shade to retain rich pink coloration.',
    photo:
  ...
  },
  {
    ...
    unit: 'kg',
    shortDescription:
      'Traditional wild-crafted mountain Echium amoenum with deep purple bell-shaped petals, celebrated for its calming and soothing infusion.',
    fullDescription:
      'Gol Gavzaban is the legendary calming blossom of Persian traditional medicine, hand-gathered from high altitudes in the Alborz mountain range.',
    photo:
  ...
  },
  {
    ...
    unit: 'kg',
    shortDescription:
      'Sun-baked citrus limes with tart, fermented, and smoky notes essential for Middle Eastern culinary masterstocks and herbal teas.',
    fullDescription:
      'Limoo Amani (Black & brown dried limes) are small limes brined and naturally dried under the hot desert sun until brittle and darkly aromatic.',
    photo:
  ...
  // Persian Nuts & Kernels
  {
    ...
    unit: 'kg',
    shortDescription:
      'The "Super Long" Persian pistachio, known for its elegant elongated shell, effortless cracking, and rich nutty sweetness.',
    fullDescription:
      'Akbari is the most luxurious and prestigious cultivar of Persian pistachio. Naturally smiling with an easy-to-open shell, it offers an elongated kernel with unmatched buttery flavor and vibrant emerald meat.',
    photo:
      'https://images.unsplash.com/photo-1525904097878-94fb15835963?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    unit: 'kg',
    shortDescription:
      'Spherical Persian pistachio with high ounce density, perfect for confectionery, gelato manufacturing, and bulk snack packaging.',
    fullDescription:
      'Fandooghi (Round pistachio) is the primary commercial export variety of Iran. Its compact rounded shape produces the highest number of nuts per ounce, making it exceptionally economical for wholesale buyers.',
    photo:
      'https://images.unsplash.com/photo-1543208543-34e8d35f492b?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    unit: 'kg',
    shortDescription:
      'Vibrant emerald green skinless pistachio kernels sorted by color grades (A-D) for luxury pastry, Swiss chocolate, and savory charcuterie.',
    fullDescription:
      'Green Peeled Pistachio Kernels are harvested early before complete shell maturity to capture the deep, radiant green core.',
    photo:
  ...
  // Persian Teas
  {
    ...
    fullDescription:
      'Lahijan is the historic capital of Iranian tea, nestled on the verdant subtropical slopes of Gilan by the Caspian Sea. Grown without synthetic pesticides thanks to brisk Caspian winters, this orthodox black tea features a distinct amber-ruby liquor.',
    photo:
