  ...
  loadLocalData() {
    try {
      ...
      if (fs.existsSync(DB_FILE)) {
        ...
        return {
          company: parsed.company || INITIAL_COMPANY2,
          products: parsed.products && parsed.products.length > 0 ? parsed.products : INITIAL_PRODUCTS2,
    ...
    const initial = {
      company: INITIAL_COMPANY2,
      products: INITIAL_PRODUCTS2,
      inquiries: []
    };
